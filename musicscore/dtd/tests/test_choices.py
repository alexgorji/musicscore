...
class Test(TestCase):
    def test_expand(self):
        ...
        # print(seq2)
        # print(seq2.choices)
        # print(seq2.choices[0].dump())
        # print(ch4.choices[0].dump())
        ...
        choices = [choice.get_leaves(key=lambda leaf: leaf.type_.__name__) for choice in lyric_dtd.choices]

        self.assertEqual(choices, result)

        result = [[['Grace', [[['Chord', 'Pitch']]]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type', 'Dot',
                  ...
                  [['Grace', [[['Chord', 'Rest']]]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type', 'Dot',
                   'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']], 'Beam',
                   'Notations', 'Lyric', 'Play'],
                  [['Grace', [[['Chord', 'Pitch']], 'Tie']], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Grace', [[['Chord', 'Unpitched']], 'Tie']], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Grace', [[['Chord', 'Rest']], 'Tie']], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Grace', ['Cue', [['Chord', 'Pitch']]]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Grace', ['Cue', [['Chord', 'Unpitched']]]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Grace', ['Cue', [['Chord', 'Rest']]]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Cue', [['Chord', 'Pitch']], [['Duration']]], 'Instrument', [['FootNote', 'Level', 'Voice']],
                   'Type', 'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText',
                   [['StaffElement']], 'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Cue', [['Chord', 'Unpitched']], [['Duration']]], 'Instrument', [['FootNote', 'Level', 'Voice']],
                   'Type', 'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText',
                   [['StaffElement']], 'Beam', 'Notations', 'Lyric', 'Play'],
                  [['Cue', [['Chord', 'Rest']], [['Duration']]], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play'],
                  [[[['Chord', 'Pitch']], [['Duration']], 'Tie'], 'Instrument', [['FootNote', 'Level', 'Voice']],
                   'Type', 'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText',
                   [['StaffElement']], 'Beam', 'Notations', 'Lyric', 'Play'],
                  [[[['Chord', 'Unpitched']], [['Duration']], 'Tie'], 'Instrument', [['FootNote', 'Level', 'Voice']],
                   'Type', 'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText',
                   [['StaffElement']], 'Beam', 'Notations', 'Lyric', 'Play'],
                  [[[['Chord', 'Rest']], [['Duration']], 'Tie'], 'Instrument', [['FootNote', 'Level', 'Voice']], 'Type',
                   'Dot', 'Accidental', 'TimeModification', 'Stem', 'Notehead', 'NoteheadText', [['StaffElement']],
                   'Beam', 'Notations', 'Lyric', 'Play']]
        choices = [choice.get_leaves(key=lambda leaf: leaf.type_.__name__) for choice in note_dtd.choices]
        self.assertEqual(choices, result)
        # el.choices
        # ch1.choices
