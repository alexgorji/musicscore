...
A central feature of musictree is Beat's :obj:`~musictree.beat.Beat._quantize_quarter_durations()` method. A list of possible
...
16ths and sextuplets will be used. :obj:`~musictree.beat.Beat._quantize_quarter_durations()` calculates always the most accurate
