...
# from musicscore.timewise import Timwise, MusicNote, Measure, Part
...
#     #     self.timewise.add_part()
#     #     self.timewise.add_measure()
#     #     note = Note(Pitch('D'), quarter_duration=1.5)
#     #     self.timewise.add_note(measure_number=1, part_number=2, note=note)
#     #     note = Note(Pitch('E', alter=-1, octave=5), quarter_duration=2)
#     #     self.timewise.add_note(measure_number=1, part_number=2, note=note)
#     #
...
#         self.timewise.add_part()
#         self.timewise.add_measure()
#         note = MusicNote(Pitch(), quarter_duration=2)
