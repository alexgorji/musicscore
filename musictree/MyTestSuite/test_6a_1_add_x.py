...
from musicxml.xmlelement.xmlelement import XMLAccent, XMLHammerOn, XMLPullOff

from musictree.chord import Chord
from musictree.part import Part
from musictree.score import Score
from musictree.tests.util import IdTestCase, create_technical, create_articulation, create_ornament
from musictree.util import XML_TECHNICAL_CLASSES, XML_ARTICULATION_CLASSES, XML_OTHER_NOTATIONS, XML_DYNAMIC_CLASSES, XML_ORNAMENT_CLASSES
...
class TestHelloWorldTechnicals(IdTestCase):
    def test_export_hello_world(self):
        ...
        for index, cls in enumerate(XML_ORNAMENT_CLASSES):
            ch = Chord(60, 1)
