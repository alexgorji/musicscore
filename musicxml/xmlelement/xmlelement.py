...
__all__=['XMLScorePartwise', 'XMLPart', 'XMLMeasure', 'XMLDirective', 'XMLSupports', 'XMLEffect', 'XMLVerticalTurn', 'XMLDoit', 'XMLOpus', 'XMLSffz', 'XMLDampAll', 'XMLMidiUnpitched', 'XMLMiscellaneousField', 'XMLStaffTuning', 'XMLCue', 'XMLOtherAppearance', 'XMLMidiDevice', 'XMLNumeralKey', 'XMLMovementNumber', 'XMLOtherDynamics', 'XMLSf', 'XMLWork', 'XMLMute', 'XMLNoteSize', 'XMLSync', 'XMLAttributes', 'XMLCreator', 'XMLRootStep', 'XMLVirtualName', 'XMLFz', 'XMLStaffDistance', 'XMLDot', 'XMLTimeModification', 'XMLStick', 'XMLHarmonClosed', 'XMLEnsemble', 'XMLEncoding', 'XMLNoteheadText', 'XMLDisplayStep', 'XMLGroupBarline', 'XMLBass', 'XMLEndParagraph', 'XMLText', 'XMLMeasureNumbering', 'XMLTopMargin', 'XMLSenzaMisura', 'XMLDelayedTurn', 'XMLTenuto', 'XMLEncodingDate', 'XMLSolo', 'XMLVolume', 'XMLBeatUnitTied', 'XMLInstrumentLink', 'XMLBeatRepeat', 'XMLRest', 'XMLOpen', 'XMLStaff', 'XMLTupletDot', 'XMLWorkNumber', 'XMLElevation', 'XMLFrameNote', 'XMLScoreInstrument', 'XMLStaffDivide', 'XMLGroupAbbreviation', 'XMLGlass', 'XMLPullOff', 'XMLPartList', 'XMLVirtualLibrary', 'XMLForward', 'XMLBarre', 'XMLBrassBend', 'XMLPlop', 'XMLPitched', 'XMLNormalType', 'XMLArrowhead', 'XMLWood', 'XMLKeyAlter', 'XMLWords', 'XMLSystemMargins', 'XMLFfff', 'XMLInversion', 'XMLTrillMark', 'XMLFlip', 'XMLMusicFont', 'XMLAccordionHigh', 'XMLSecond', 'XMLActualNotes', 'XMLIpa', 'XMLRightMargin', 'XMLStaffType', 'XMLNumeral', 'XMLClef', 'XMLMiscellaneous', 'XMLPageHeight', 'XMLTechnical', 'XMLDetachedLegato', 'XMLLink', 'XMLLyricLanguage', 'XMLRights', 'XMLSwingStyle', 'XMLPedalAlter', 'XMLRootAlter', 'XMLPrint', 'XMLDistance', 'XMLUnstress', 'XMLHoleShape', 'XMLAlter', 'XMLFingering', 'XMLThumbPosition', 'XMLSlashDot', 'XMLArrowDirection', 'XMLBeam', 'XMLMetronomeDot', 'XMLInstrumentName', 'XMLAssess', 'XMLRepeat', 'XMLToe', 'XMLHandbell', 'XMLStem', 'XMLHarmonMute', 'XMLWordFont', 'XMLMovementTitle', 'XMLPerMinute', 'XMLNote', 'XMLSmear', 'XMLTouchingPitch', 'XMLPan', 'XMLCircularArrow', 'XMLConcertScore', 'XMLEncoder', 'XMLBreathMark', 'XMLDefaults', 'XMLAccidentalText', 'XMLAccordionMiddle', 'XMLSnapPizzicato', 'XMLPageMargins', 'XMLTie', 'XMLAccidental', 'XMLChord', 'XMLGolpe', 'XMLTuningStep', 'XMLFalloff', 'XMLBarStyle', 'XMLRfz', 'XMLStaccato', 'XMLSfzp', 'XMLWavyLine', 'XMLIdentification', 'XMLSoundingPitch', 'XMLNumeralRoot', 'XMLSystemDistance', 'XMLPartSymbol', 'XMLP', 'XMLInstruments', 'XMLN', 'XMLCancel', 'XMLDelayedInvertedTurn', 'XMLSlur', 'XMLMidiChannel', 'XMLMetronomeArrows', 'XMLNumeralAlter', 'XMLDownBow', 'XMLPartNameDisplay', 'XMLLeftDivider', 'XMLVirtualInstrument', 'XMLCreditImage', 'XMLEnding', 'XMLBeatUnit', 'XMLDoubleTongue', 'XMLFigureNumber', 'XMLDivisions', 'XMLMillimeters', 'XMLInstrumentAbbreviation', 'XMLPppppp', 'XMLRelease', 'XMLOtherDirection', 'XMLAccent', 'XMLArtificial', 'XMLTenths', 'XMLAccidentalMark', 'XMLOtherOrnament', 'XMLMetronomeRelation', 'XMLBassStep', 'XMLOtherPercussion', 'XMLPageWidth', 'XMLStickType', 'XMLClefOctaveChange', 'XMLSfp', 'XMLDynamics', 'XMLFunction', 'XMLBracket', 'XMLScaling', 'XMLStaffLines', 'XMLPedalStep', 'XMLSchleifer', 'XMLGroupName', 'XMLGroupNameDisplay', 'XMLSlide', 'XMLDisplayOctave', 'XMLFff', 'XMLArrowStyle', 'XMLScorePart', 'XMLOctaveShift', 'XMLCreditSymbol', 'XMLTap', 'XMLGroupLink', 'XMLBeater', 'XMLPp', 'XMLPppp', 'XMLTremolo', 'XMLMp', 'XMLCapo', 'XMLGroupSymbol', 'XMLGrace', 'XMLKind', 'XMLStickMaterial', 'XMLStress', 'XMLSpiccato', 'XMLOctave', 'XMLTupletNormal', 'XMLDisplayText', 'XMLNotations', 'XMLLineDetail', 'XMLLyric', 'XMLNonArpeggiate', 'XMLFifths', 'XMLMeasureRepeat', 'XMLTuplet', 'XMLStickLocation', 'XMLPrefix', 'XMLPartClef', 'XMLInterchangeable', 'XMLTurn', 'XMLPartAbbreviation', 'XMLPedalTuning', 'XMLCredit', 'XMLPpppp', 'XMLWithBar', 'XMLFootnote', 'XMLF', 'XMLFigure', 'XMLSemiPitched', 'XMLAccordionLow', 'XMLTuningAlter', 'XMLSource', 'XMLPageLayout', 'XMLTied', 'XMLPedal', 'XMLRightDivider', 'XMLPitch', 'XMLOtherNotation', 'XMLKey', 'XMLExceptVoice', 'XMLMetronomeTuplet', 'XMLSlashType', 'XMLHarpPedals', 'XMLPf', 'XMLMetronomeBeam', 'XMLRehearsal', 'XMLString', 'XMLInvertedVerticalTurn', 'XMLHarmonic', 'XMLRelation', 'XMLAccord', 'XMLDegreeAlter', 'XMLImage', 'XMLArpeggiate', 'XMLBeatUnitDot', 'XMLMeasureDistance', 'XMLStaffLayout', 'XMLHeel', 'XMLSoftAccent', 'XMLBend', 'XMLFiguredBass', 'XMLDashes', 'XMLTopSystemDistance', 'XMLInstrumentSound', 'XMLPpp', 'XMLStaffSize', 'XMLWorkTitle', 'XMLDegreeValue', 'XMLKeyStep', 'XMLPluck', 'XMLGroupTime', 'XMLMf', 'XMLSuffix', 'XMLShake', 'XMLNormalNotes', 'XMLBeatType', 'XMLHoleType', 'XMLSound', 'XMLStrongAccent', 'XMLNatural', 'XMLHarmony', 'XMLKeyAccidental', 'XMLMeasureStyle', 'XMLHoleClosed', 'XMLDirection', 'XMLTime', 'XMLSfpp', 'XMLLeftMargin', 'XMLTimeRelation', 'XMLOtherListening', 'XMLInvertedTurn', 'XMLRoot', 'XMLFirst', 'XMLBarline', 'XMLFrame', 'XMLTupletNumber', 'XMLOffset', 'XMLBasePitch', 'XMLFf', 'XMLBendAlter', 'XMLPreBend', 'XMLMetronome', 'XMLDamp', 'XMLChromatic', 'XMLDirectionType', 'XMLFrameStrings', 'XMLMode', 'XMLFp', 'XMLSfz', 'XMLPartTranspose', 'XMLElision', 'XMLAppearance', 'XMLSoftware', 'XMLNormalDot', 'XMLFermata', 'XMLDuration', 'XMLGlyph', 'XMLPlayerName', 'XMLBassSeparator', 'XMLSystemLayout', 'XMLInvertedMordent', 'XMLPrincipalVoice', 'XMLInstrumentChange', 'XMLSign', 'XMLBeats', 'XMLPercussion', 'XMLEyeglasses', 'XMLNotehead', 'XMLStaves', 'XMLSymbol', 'XMLNumeralMode', 'XMLHaydn', 'XMLTuningOctave', 'XMLLine', 'XMLCreditType', 'XMLWedge', 'XMLLyricFont', 'XMLPlayer', 'XMLType', 'XMLOctaveChange', 'XMLPartAbbreviationDisplay', 'XMLRf', 'XMLInstrument', 'XMLFfffff', 'XMLMeasureLayout', 'XMLOtherTechnical', 'XMLTupletType', 'XMLStaccatissimo', 'XMLLevel', 'XMLMidiInstrument', 'XMLLaughing', 'XMLPartGroup', 'XMLMordent', 'XMLScordatura', 'XMLDegreeType', 'XMLMembrane', 'XMLOtherPlay', 'XMLMetronomeTied', 'XMLEncodingDescription', 'XMLTupletActual', 'XMLGroupAbbreviationDisplay', 'XMLMultipleRest', 'XMLUnpitched', 'XMLBookmark', 'XMLTranspose', 'XMLBottomMargin', 'XMLStopped', 'XMLFrameFrets', 'XMLCaesura', 'XMLCreditWords', 'XMLStraight', 'XMLLineWidth', 'XMLStep', 'XMLMidiBank', 'XMLHammerOn', 'XMLStringMute', 'XMLOpenString', 'XMLArrow', 'XMLEndLine', 'XMLUpBow', 'XMLVoice', 'XMLKeyOctave', 'XMLOtherArticulation', 'XMLWait', 'XMLFirstFret', 'XMLListen', 'XMLGroup', 'XMLExtend', 'XMLFingernails', 'XMLSystemDividers', 'XMLMidiProgram', 'XMLCoda', 'XMLHalfMuted', 'XMLDouble', 'XMLBassAlter', 'XMLPlay', 'XMLPartName', 'XMLAccordionRegistration', 'XMLArticulations', 'XMLMetal', 'XMLSwingType', 'XMLFret', 'XMLSyllabic', 'XMLTimpani', 'XMLBackup', 'XMLSlash', 'XMLNumeralFifths', 'XMLPartLink', 'XMLOrnaments', 'XMLGrouping', 'XMLSwing', 'XMLFeature', 'XMLGlissando', 'XMLFffff', 'XMLMidiName', 'XMLSegno', 'XMLOtherListen', 'XMLDiatonic', 'XMLHumming', 'XMLListening', 'XMLScoop', 'XMLMetronomeType', 'XMLMetronomeNote', 'XMLTripleTongue', 'XMLDegree', 'XMLStaffDetails', 'XMLForPart', 'XMLHole']
