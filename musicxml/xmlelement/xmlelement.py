...
__all__=['XMLScorePartwise', 'XMLPart', 'XMLMeasure', 'XMLDirective', 'XMLStress', 'XMLDisplayOctave', 'XMLFalloff', 'XMLMordent', 'XMLCapo', 'XMLArticulations', 'XMLRest', 'XMLDiatonic', 'XMLBeatUnitDot', 'XMLFootnote', 'XMLTurn', 'XMLSnapPizzicato', 'XMLOpen', 'XMLPlay', 'XMLPartName', 'XMLSmear', 'XMLNumeral', 'XMLPartClef', 'XMLMetronomeRelation', 'XMLTopMargin', 'XMLLaughing', 'XMLArrowStyle', 'XMLStaffDistance', 'XMLTripleTongue', 'XMLFunction', 'XMLTupletType', 'XMLOtherArticulation', 'XMLVirtualInstrument', 'XMLScoop', 'XMLPageLayout', 'XMLMp', 'XMLPartLink', 'XMLNumeralMode', 'XMLPartTranspose', 'XMLTap', 'XMLGroup', 'XMLNormalDot', 'XMLDoit', 'XMLFifths', 'XMLLineWidth', 'XMLDirectionType', 'XMLCreditSymbol', 'XMLSlur', 'XMLKeyAlter', 'XMLSlashType', 'XMLFermata', 'XMLStopped', 'XMLDoubleTongue', 'XMLFiguredBass', 'XMLHarmonic', 'XMLTenths', 'XMLMidiProgram', 'XMLBasePitch', 'XMLFlip', 'XMLListen', 'XMLEncoding', 'XMLHoleShape', 'XMLElision', 'XMLHaydn', 'XMLChord', 'XMLSffz', 'XMLThumbPosition', 'XMLBendAlter', 'XMLEncoder', 'XMLDashes', 'XMLAlter', 'XMLSfp', 'XMLPullOff', 'XMLRootAlter', 'XMLHarmonClosed', 'XMLMetronomeNote', 'XMLCreditType', 'XMLGrace', 'XMLGroupAbbreviationDisplay', 'XMLBackup', 'XMLType', 'XMLPartAbbreviation', 'XMLMeasureRepeat', 'XMLNatural', 'XMLFingernails', 'XMLTuningAlter', 'XMLBass', 'XMLCoda', 'XMLSlash', 'XMLAccidental', 'XMLMetronomeTied', 'XMLListening', 'XMLMeasureLayout', 'XMLStrongAccent', 'XMLString', 'XMLBookmark', 'XMLGlass', 'XMLArtificial', 'XMLTouchingPitch', 'XMLInvertedVerticalTurn', 'XMLSystemDividers', 'XMLAccent', 'XMLStickLocation', 'XMLP', 'XMLInterchangeable', 'XMLUpBow', 'XMLKeyAccidental', 'XMLWorkTitle', 'XMLArrow', 'XMLBarline', 'XMLRf', 'XMLNumeralRoot', 'XMLMute', 'XMLAccordionMiddle', 'XMLGroupBarline', 'XMLStaffType', 'XMLHarmonMute', 'XMLKeyOctave', 'XMLFirst', 'XMLCircularArrow', 'XMLBassStep', 'XMLDegreeAlter', 'XMLMidiChannel', 'XMLHole', 'XMLEnding', 'XMLAccordionHigh', 'XMLHumming', 'XMLPf', 'XMLLineDetail', 'XMLPartGroup', 'XMLWordFont', 'XMLKey', 'XMLArpeggiate', 'XMLSwing', 'XMLInstrumentAbbreviation', 'XMLLyricFont', 'XMLNotehead', 'XMLSystemLayout', 'XMLBend', 'XMLMeasureDistance', 'XMLAccidentalMark', 'XMLOctave', 'XMLVolume', 'XMLSlide', 'XMLFret', 'XMLStaffLayout', 'XMLPrint', 'XMLTranspose', 'XMLFp', 'XMLVirtualName', 'XMLMovementNumber', 'XMLWedge', 'XMLScorePart', 'XMLWorkNumber', 'XMLPedal', 'XMLRoot', 'XMLWait', 'XMLRfz', 'XMLBarStyle', 'XMLSystemDistance', 'XMLExceptVoice', 'XMLInstrumentName', 'XMLScordatura', 'XMLGroupName', 'XMLMetronomeBeam', 'XMLEffect', 'XMLMidiName', 'XMLStaffDetails', 'XMLFff', 'XMLPrefix', 'XMLMeasureStyle', 'XMLOpenString', 'XMLTimpani', 'XMLSuffix', 'XMLTupletNumber', 'XMLFigureNumber', 'XMLWords', 'XMLSoundingPitch', 'XMLPitch', 'XMLTie', 'XMLSchleifer', 'XMLForward', 'XMLCancel', 'XMLPitched', 'XMLDelayedInvertedTurn', 'XMLPartList', 'XMLOtherAppearance', 'XMLPpp', 'XMLF', 'XMLInvertedMordent', 'XMLStaff', 'XMLDirection', 'XMLAccordionLow', 'XMLElevation', 'XMLConcertScore', 'XMLUnpitched', 'XMLInstruments', 'XMLArrowhead', 'XMLMf', 'XMLBeatUnitTied', 'XMLDegreeType', 'XMLTuplet', 'XMLEyeglasses', 'XMLImage', 'XMLChromatic', 'XMLGlyph', 'XMLFirstFret', 'XMLStraight', 'XMLPlop', 'XMLRightDivider', 'XMLOtherOrnament', 'XMLSyllabic', 'XMLTimeRelation', 'XMLSupports', 'XMLSign', 'XMLSenzaMisura', 'XMLDetachedLegato', 'XMLSfzp', 'XMLMetal', 'XMLFf', 'XMLBeater', 'XMLRelease', 'XMLAssess', 'XMLMetronomeType', 'XMLOtherTechnical', 'XMLNonArpeggiate', 'XMLFfffff', 'XMLDownBow', 'XMLPageMargins', 'XMLStaffLines', 'XMLDegreeValue', 'XMLLink', 'XMLLine', 'XMLTechnical', 'XMLPlayer', 'XMLShake', 'XMLSoftware', 'XMLFrameFrets', 'XMLDampAll', 'XMLLyric', 'XMLActualNotes', 'XMLWork', 'XMLPerMinute', 'XMLBarre', 'XMLRootStep', 'XMLGroupSymbol', 'XMLStaves', 'XMLPercussion', 'XMLOctaveChange', 'XMLOtherPlay', 'XMLStem', 'XMLStaffSize', 'XMLStaffTuning', 'XMLSecond', 'XMLDistance', 'XMLOrnaments', 'XMLDisplayText', 'XMLUnstress', 'XMLPppp', 'XMLMode', 'XMLBeatRepeat', 'XMLMembrane', 'XMLInversion', 'XMLOtherPercussion', 'XMLNoteheadText', 'XMLStickMaterial', 'XMLPageHeight', 'XMLTenuto', 'XMLMovementTitle', 'XMLSlashDot', 'XMLVerticalTurn', 'XMLVirtualLibrary', 'XMLHandbell', 'XMLOffset', 'XMLTremolo', 'XMLSpiccato', 'XMLPedalStep', 'XMLHarmony', 'XMLSwingStyle', 'XMLSolo', 'XMLNumeralFifths', 'XMLSound', 'XMLKeyStep', 'XMLTopSystemDistance', 'XMLTime', 'XMLStaffDivide', 'XMLAccord', 'XMLAccidentalText', 'XMLLevel', 'XMLMeasureNumbering', 'XMLLeftDivider', 'XMLSymbol', 'XMLBassSeparator', 'XMLIpa', 'XMLScaling', 'XMLClefOctaveChange', 'XMLFfff', 'XMLPpppp', 'XMLPreBend', 'XMLEnsemble', 'XMLInvertedTurn', 'XMLMetronomeDot', 'XMLDynamics', 'XMLHeel', 'XMLNormalType', 'XMLHoleType', 'XMLMidiDevice', 'XMLEncodingDescription', 'XMLTupletDot', 'XMLArrowDirection', 'XMLScoreInstrument', 'XMLMetronome', 'XMLOtherDynamics', 'XMLBeats', 'XMLNumeralAlter', 'XMLStaccato', 'XMLMillimeters', 'XMLSwingType', 'XMLDouble', 'XMLEncodingDate', 'XMLHarpPedals', 'XMLBreathMark', 'XMLMidiBank', 'XMLFz', 'XMLPlayerName', 'XMLDegree', 'XMLCue', 'XMLRepeat', 'XMLBrassBend', 'XMLTied', 'XMLBeatType', 'XMLCreditWords', 'XMLCreditImage', 'XMLPluck', 'XMLSource', 'XMLBeatUnit', 'XMLTrillMark', 'XMLAccordionRegistration', 'XMLStringMute', 'XMLCreator', 'XMLRightMargin', 'XMLFrameNote', 'XMLGroupLink', 'XMLDivisions', 'XMLDot', 'XMLOctaveShift', 'XMLBassAlter', 'XMLMusicFont', 'XMLNumeralKey', 'XMLRehearsal', 'XMLDamp', 'XMLInstrumentChange', 'XMLInstrumentLink', 'XMLRights', 'XMLBracket', 'XMLStep', 'XMLWood', 'XMLSystemMargins', 'XMLSoftAccent', 'XMLPp', 'XMLLyricLanguage', 'XMLAppearance', 'XMLStick', 'XMLFigure', 'XMLBottomMargin', 'XMLStickType', 'XMLWavyLine', 'XMLPageWidth', 'XMLCaesura', 'XMLLeftMargin', 'XMLTupletNormal', 'XMLPppppp', 'XMLDelayedTurn', 'XMLNormalNotes', 'XMLOtherNotation', 'XMLMetronomeTuplet', 'XMLRelation', 'XMLSf', 'XMLStaccatissimo', 'XMLGolpe', 'XMLTuningStep', 'XMLDuration', 'XMLEndParagraph', 'XMLFffff', 'XMLFrameStrings', 'XMLMiscellaneousField', 'XMLTimeModification', 'XMLNoteSize', 'XMLMiscellaneous', 'XMLInstrumentSound', 'XMLSemiPitched', 'XMLVoice', 'XMLMidiUnpitched', 'XMLOtherDirection', 'XMLTuningOctave', 'XMLSfpp', 'XMLPan', 'XMLDisplayStep', 'XMLGlissando', 'XMLMidiInstrument', 'XMLOtherListen', 'XMLN', 'XMLFrame', 'XMLOpus', 'XMLIdentification', 'XMLSync', 'XMLPartNameDisplay', 'XMLPartAbbreviationDisplay', 'XMLPartSymbol', 'XMLText', 'XMLCredit', 'XMLPedalAlter', 'XMLEndLine', 'XMLAttributes', 'XMLNotations', 'XMLSfz', 'XMLMultipleRest', 'XMLClef', 'XMLHalfMuted', 'XMLNote', 'XMLSegno', 'XMLGroupTime', 'XMLForPart', 'XMLFeature', 'XMLMetronomeArrows', 'XMLTupletActual', 'XMLHoleClosed', 'XMLDefaults', 'XMLHammerOn', 'XMLGroupAbbreviation', 'XMLToe', 'XMLWithBar', 'XMLBeam', 'XMLPedalTuning', 'XMLGrouping', 'XMLFingering', 'XMLExtend', 'XMLGroupNameDisplay', 'XMLPrincipalVoice', 'XMLInstrument', 'XMLKind', 'XMLOtherListening']
