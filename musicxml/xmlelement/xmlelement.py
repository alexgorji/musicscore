...
class XMLGroupTime(XMLElement):
    """
    The group-time element indicates that the displayed time signatures should stretch across all parts and staves in the group.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/group-time/>`_
...
class XMLGolpe(XMLElement):
    """
    The golpe element represents the golpe symbol that is used for tapping the pick guard in guitar music.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/golpe/>`_
...
class XMLPartTranspose(XMLElement):
    """
    The chromatic element in a part-transpose element will usually have a non-zero value, since octave transpositions can be represented in concert scores using the transpose element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/part-transpose/>`_
...
class XMLFrameFrets(XMLElement):
    """
    The frame-frets element gives the overall size of the frame in horizontal spaces (frets).`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/frame-frets/>`_
...
class XMLScoop(XMLElement):
    """
    The scoop element is an indeterminate slide attached to a single note. The scoop appears before the main note and comes from below the main pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/scoop/>`_
...
class XMLAccordionHigh(XMLElement):
    """
    The accordion-high element indicates the presence of a dot in the high (4') section of the registration symbol. This element is omitted if no dot is present.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/accordion-high/>`_
...
class XMLEndParagraph(XMLElement):
    """
    The end-paragraph element comes from RP-017 for Standard MIDI File Lyric meta-events. It facilitates lyric display for Karaoke and similar applications.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/end-paragraph/>`_
...
class XMLDamp(XMLElement):
    """
    The damp element specifies a harp damping mark.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/damp/>`_
...
class XMLTupletActual(XMLElement):
    """
    The tuplet-actual element provide optional full control over how the actual part of the tuplet is displayed, including number and note type (with dots). If any of these elements are absent, their values are based on the time-modification element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tuplet-actual/>`_
...
class XMLMetronomeRelation(XMLElement):
    """
    The metronome-relation element describes the relationship symbol that goes between the two sets of metronome-note elements. The currently allowed value is equals, but this may expand in future versions. If the element is empty, the equals value is used.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/metronome-relation/>`_
...
class XMLHoleShape(XMLElement):
    """
    The optional hole-shape element indicates the shape of the hole symbol; the default is a circle.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/hole-shape/>`_
...
class XMLBasePitch(XMLElement):
    """
    The base pitch is the pitch at which the string is played before touching to create the harmonic.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/base-pitch/>`_
...
class XMLTenuto(XMLElement):
    """
    The tenuto element indicates a tenuto line symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tenuto/>`_
...
class XMLLaughing(XMLElement):
    """
    The laughing element represents a laughing voice.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/laughing/>`_
...
class XMLTime(XMLElement):
    """
    Time signatures are represented by the beats element for the numerator and the beat-type element for the denominator.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/time/>`_
...
class XMLMetronomeDot(XMLElement):
    """
    The metronome-dot element works like the dot element in defining metric relationships.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/metronome-dot/>`_
...
class XMLBeatUnitDot(XMLElement):
    """
    The beat-unit-dot element is used to specify any augmentation dots for a metronome mark note.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/beat-unit-dot/>`_
...
class XMLMetronomeType(XMLElement):
    """
    The metronome-type element works like the type element in defining metric relationships.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/metronome-type/>`_
...
class XMLDoit(XMLElement):
    """
    The doit element is an indeterminate slide attached to a single note. The doit appears after the main note and goes above the main pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/doit/>`_
...
class XMLRehearsal(XMLElement):
    """
    The rehearsal element specifies letters, numbers, and section names that are notated in the score for reference during rehearsal. The enclosure is square if not specified. The language is Italian ("it") if not specified. Left justification is used if not specified.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/rehearsal/>`_
...
class XMLTupletNormal(XMLElement):
    """
    The tuplet-normal element provide optional full control over how the normal part of the tuplet is displayed, including number and note type (with dots). If any of these elements are absent, their values are based on the time-modification element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tuplet-normal/>`_
...
class XMLMetronomeArrows(XMLElement):
    """
    If the metronome-arrows element is present, it indicates that metric modulation arrows are displayed on both sides of the metronome mark.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/metronome-arrows/>`_
...
class XMLMordent(XMLElement):
    """
    The mordent element represents the sign with the vertical line. The choice of which mordent sign is inverted differs between MusicXML and SMuFL. The long attribute is "no" by default.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/mordent/>`_
...
class XMLOtherOrnament(XMLElement):
    """
    The other-ornament element is used to define any ornaments not yet in the MusicXML format. The smufl attribute can be used to specify a particular ornament, allowing application interoperability without requiring every SMuFL ornament to have a MusicXML element equivalent. Using the other-ornament element without the smufl attribute allows for extended representation, though without application interoperability.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/other-ornament/>`_
...
class XMLWorkTitle(XMLElement):
    """
    The work-title element specifies the title of a work, not including its opus or other work number.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/work-title/>`_
...
class XMLNormalType(XMLElement):
    """
    If the type associated with the number in the normal-notes element is different than the current note type (e.g., a quarter note within an eighth note triplet), then the normal-notes type (e.g. eighth) is specified in the normal-type and normal-dot elements.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/normal-type/>`_
...
class XMLPartClef(XMLElement):
    """
    The part-clef element is used for transpositions that also include a change of clef, as for instruments such as bass clarinet.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/part-clef/>`_
...
class XMLDouble(XMLElement):
    """
    If the double element is present, it indicates that the music is doubled one octave from what is currently written.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/double/>`_
...
class XMLTuningStep(XMLElement):
    """
    The tuning-step element is represented like the step element, with a different name to reflect its different function in string tuning.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tuning-step/>`_
...
class XMLOctaveChange(XMLElement):
    """
    The octave-change element indicates how many octaves to add to get from written pitch to sounding pitch. The octave-change element should be included when using transposition intervals of an octave or more, and should not be present for intervals of less than an octave.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/octave-change/>`_
...
class XMLExceptVoice(XMLElement):
    """
    The except-voice element is used to specify a combination of slash notation and regular notation. Any note elements that are in voices specified by the except-voice elements are displayed in normal notation, in addition to the slash notation that is always displayed.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/except-voice/>`_
...
class XMLBeatUnit(XMLElement):
    """
    The beat-unit element indicates the graphical note type to use in a metronome mark.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/beat-unit/>`_
...
class XMLKey(XMLElement):
    """
    The key element represents a key signature. Both traditional and non-traditional key signatures are supported. The optional number attribute refers to staff numbers. If absent, the key signature applies to all staves in the part.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/key/>`_
...
class XMLStaccato(XMLElement):
    """
    The staccato element is used for a dot articulation, as opposed to a stroke or a wedge.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staccato/>`_
...
class XMLDoubleTongue(XMLElement):
    """
    The double-tongue element represents the double tongue symbol (two dots arranged horizontally).`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/double-tongue/>`_
...
class XMLPedalAlter(XMLElement):
    """
    The pedal-alter element defines the chromatic alteration for a single harp pedal.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/pedal-alter/>`_
...
class XMLFalloff(XMLElement):
    """
    The falloff element is an indeterminate slide attached to a single note. The falloff appears after the main note and goes below the main pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/falloff/>`_
...
class XMLRelation(XMLElement):
    """
    A related resource for the music that is encoded. This is similar to the Dublin Core relation element. Standard type values are music, words, and arrangement, but other types may be used.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/relation/>`_
...
class XMLStrongAccent(XMLElement):
    """
    The strong-accent element indicates a vertical accent mark.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/strong-accent/>`_
...
class XMLBassAlter(XMLElement):
    """
    The bass-alter element represents the chromatic alteration of the bass of the current chord within the harmony element. In some chord styles, the text for the bass-step element may include bass-alter information. In that case, the print-object attribute of the bass-alter element can be set to no. The location attribute indicates whether the alteration should appear to the left or the right of the bass-step; it is right if not specified.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/bass-alter/>`_
...
class XMLStopped(XMLElement):
    """
    The stopped element represents the stopped symbol, which looks like a plus sign. The smufl attribute distinguishes different SMuFL glyphs that have a similar appearance such as handbellsMalletBellSuspended and guitarClosePedal. If not present, the default glyph is brassMuteClosed.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/stopped/>`_
...
class XMLWorkNumber(XMLElement):
    """
    The work-number element specifies the number of a work, such as its opus number.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/work-number/>`_
...
class XMLSlashDot(XMLElement):
    """
    The slash-dot element is used to specify any augmentation dots in the note type used to display repetition marks.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/slash-dot/>`_
...
class XMLAccordionLow(XMLElement):
    """
    The accordion-low element indicates the presence of a dot in the low (16') section of the registration symbol. This element is omitted if no dot is present.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/accordion-low/>`_
...
class XMLSlashType(XMLElement):
    """
    The slash-type element indicates the graphical note type to use for the display of repetition marks.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/slash-type/>`_
...
class XMLRights(XMLElement):
    """
    The rights element is borrowed from Dublin Core. It contains copyright and other intellectual property notices. Words, music, and derivatives can have different types, so multiple rights elements with different type attributes are supported. Standard type values are music, words, and arrangement, but other types may be used. The type attribute is only needed when there are multiple rights elements.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/rights/>`_
...
class XMLDot(XMLElement):
    """
    One dot element is used for each dot of prolongation. The placement attribute is used to specify whether the dot should appear above or below the staff line. It is ignored for notes that appear on a staff space.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/dot/>`_
...
class XMLInvertedVerticalTurn(XMLElement):
    """
    The inverted-vertical-turn element has the turn symbol shape arranged vertically going from upper right to lower left.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/inverted-vertical-turn/>`_
...
class XMLTripleTongue(XMLElement):
    """
    The triple-tongue element represents the triple tongue symbol (three dots arranged horizontally).`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/triple-tongue/>`_
...
class XMLMeasureDistance(XMLElement):
    """
    The measure-distance element specifies the horizontal distance from the previous measure. This value is only used for systems where there is horizontal whitespace in the middle of a system, as in systems with codas. To specify the measure width, use the width attribute of the measure element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/measure-distance/>`_
...
class XMLStaffDetails(XMLElement):
    """
    The staff-details element is used to indicate different types of staves.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staff-details/>`_
...
class XMLSnapPizzicato(XMLElement):
    """
    The snap-pizzicato element represents the snap pizzicato symbol. This is a circle with a line, where the line comes inside the circle. It is distinct from the thumb-position symbol, where the line does not come inside the circle.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/snap-pizzicato/>`_
...
class XMLSoundingPitch(XMLElement):
    """
    The sounding-pitch is the pitch which is heard when playing the harmonic.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/sounding-pitch/>`_
...
class XMLVolume(XMLElement):
    """
    The volume element value is a percentage of the maximum ranging from 0 to 100, with decimal values allowed. This corresponds to a scaling value for the MIDI 1.0 channel volume controller.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/volume/>`_
...
class XMLPreBend(XMLElement):
    """
    The pre-bend element indicates that a bend is a pre-bend rather than a normal bend or a release.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/pre-bend/>`_
...
class XMLHumming(XMLElement):
    """
    The humming element represents a humming voice.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/humming/>`_
...
class XMLBeatType(XMLElement):
    """
    The beat-type element indicates the beat unit, as found in the denominator of a time signature.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/beat-type/>`_
...
class XMLInvertedTurn(XMLElement):
    """
    The inverted-turn element has the shape which goes down and then up.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/inverted-turn/>`_
...
class XMLFrameStrings(XMLElement):
    """
    The frame-strings element gives the overall size of the frame in vertical lines (strings).`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/frame-strings/>`_
...
class XMLMidiUnpitched(XMLElement):
    """
    For unpitched instruments, the midi-unpitched element specifies a MIDI 1.0 note number ranging from 1 to 128. It is usually used with MIDI banks for percussion. Note that MIDI 1.0 note numbers are generally specified from 0 to 127 rather than the 1 to 128 numbering used in this element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/midi-unpitched/>`_
...
class XMLDampAll(XMLElement):
    """
    The damp-all element specifies a harp damping mark for all strings.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/damp-all/>`_
...
class XMLGroupNameDisplay(XMLElement):
    """
    Formatting specified in the group-name-display element overrides formatting specified in the group-name element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/group-name-display/>`_
...
class XMLSign(XMLElement):
    """
    The sign element represents the clef symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/sign/>`_
...
class XMLUpBow(XMLElement):
    """
    The up-bow element represents the symbol that is used both for up-bowing on bowed instruments, and up-stroke on plucked instruments.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/up-bow/>`_
...
class XMLMidiProgram(XMLElement):
    """
    The midi-program element specifies a MIDI 1.0 program number ranging from 1 to 128.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/midi-program/>`_
...
class XMLMidiBank(XMLElement):
    """
    The midi-bank element specifies a MIDI 1.0 bank number ranging from 1 to 16,384.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/midi-bank/>`_
...
class XMLEyeglasses(XMLElement):
    """
    The eyeglasses element represents the eyeglasses symbol, common in commercial music.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/eyeglasses/>`_
...
class XMLEnsemble(XMLElement):
    """
    The ensemble element is present if performance is intended by an ensemble such as an orchestral section. The text of the ensemble element contains the size of the section, or is empty if the ensemble size is not specified.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/ensemble/>`_
...
class XMLOtherPercussion(XMLElement):
    """
    The other-percussion element represents percussion pictograms not defined elsewhere.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/other-percussion/>`_
...
class XMLHaydn(XMLElement):
    """
    The haydn element represents the Haydn ornament. This is defined in SMuFL as ornamentHaydn.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/haydn/>`_
...
class XMLDiatonic(XMLElement):
    """
    The diatonic element specifies the number of pitch steps needed to go from written to sounding pitch. This allows for correct spelling of enharmonic transpositions. This value does not include octave-change values; the values for both elements need to be added to the written pitch to get the correct sounding pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/diatonic/>`_
...
class XMLPluck(XMLElement):
    """
    The pluck element is used to specify the plucking fingering on a fretted instrument, where the fingering element refers to the fretting fingering. Typical values are p, i, m, a for pulgar/thumb, indicio/index, medio/middle, and anular/ring fingers.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/pluck/>`_
...
class XMLMovementNumber(XMLElement):
    """
    The movement-number element specifies the number of a movement.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/movement-number/>`_
...
class XMLSolo(XMLElement):
    """
    The solo element is present if performance is intended by a solo instrument.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/solo/>`_
...
class XMLBassSeparator(XMLElement):
    """
    The optional bass-separator element indicates that text, rather than a line or slash, separates the bass from what precedes it.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/bass-separator/>`_
...
class XMLOtherTechnical(XMLElement):
    """
    The other-technical element is used to define any technical indications not yet in the MusicXML format. The smufl attribute can be used to specify a particular glyph, allowing application interoperability without requiring every SMuFL technical indication to have a MusicXML element equivalent. Using the other-technical element without the smufl attribute allows for extended representation, though without application interoperability.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/other-technical/>`_
...
class XMLStaff(XMLElement):
    """
    Staff assignment is only needed for music notated on multiple staves. Used by both notes and directions. Staff values are numbers, with 1 referring to the top-most staff in a part.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staff/>`_
...
class XMLScorePart(XMLElement):
    """
    Each MusicXML part corresponds to a track in a Standard MIDI Format 1 file. The score-instrument elements are used when there are multiple instruments per track. The midi-device element is used to make a MIDI device or port assignment for the given track. Initial midi-instrument assignments may be made here as well.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/score-part/>`_
...
class XMLDetachedLegato(XMLElement):
    """
    The detached-legato element indicates the combination of a tenuto line and staccato dot symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/detached-legato/>`_
...
class XMLConcertScore(XMLElement):
    ...
    A document with a concert-score element may not contain any transpose elements that have non-zero values for either the diatonic or chromatic elements. Concert scores may include octave transpositions, so transpose elements with a double element or a non-zero octave-change element value are permitted.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/concert-score/>`_
...
class XMLVirtualLibrary(XMLElement):
    """
    The virtual-library element indicates the virtual instrument library name.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/virtual-library/>`_
...
class XMLBeats(XMLElement):
    """
    The beats element indicates the number of beats, as found in the numerator of a time signature.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/beats/>`_
...
class XMLDelayedTurn(XMLElement):
    """
    The delayed-turn element indicates a normal turn that is delayed until the end of the current note.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/delayed-turn/>`_
...
class XMLFigureNumber(XMLElement):
    """
    A figure-number is a number. Overstrikes of the figure number are represented in the suffix element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/figure-number/>`_
...
class XMLClefOctaveChange(XMLElement):
    """
    The clef-octave-change element is used for transposing clefs. A treble clef for tenors would have a value of -1.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/clef-octave-change/>`_
...
class XMLMidiName(XMLElement):
    """
    The midi-name element corresponds to a ProgramName meta-event within a Standard MIDI File.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/midi-name/>`_
...
class XMLInvertedMordent(XMLElement):
    """
    The inverted-mordent element represents the sign without the vertical line. The choice of which mordent is inverted differs between MusicXML and SMuFL. The long attribute is "no" by default.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/inverted-mordent/>`_
...
class XMLStaccatissimo(XMLElement):
    """
    The staccatissimo element is used for a wedge articulation, as opposed to a dot or a stroke.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staccatissimo/>`_
...
class XMLBendAlter(XMLElement):
    """
    The bend-alter element indicates the number of semitones in the bend, similar to the alter element. As with the alter element, numbers like 0.5 can be used to indicate microtones. Negative values indicate pre-bends or releases. The pre-bend and release elements are used to distinguish what is intended. Because the bend-alter element represents the number of steps in the bend, a release after a bend has a negative bend-alter value, not a zero value.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/bend-alter/>`_
...
class XMLArtificial(XMLElement):
    """
    The artificial element indicates that this is an artificial harmonic.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/artificial/>`_
...
class XMLCapo(XMLElement):
    """
    The capo element indicates at which fret a capo should be placed on a fretted instrument. This changes the open tuning of the strings specified by staff-tuning by the specified number of half-steps.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/capo/>`_
...
class XMLUnstress(XMLElement):
    """
    The unstress element indicates an unstressed note. It is often notated using a u-shaped symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/unstress/>`_
...
class XMLMidiChannel(XMLElement):
    """
    The midi-channel element specifies a MIDI 1.0 channel numbers ranging from 1 to 16.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/midi-channel/>`_
...
class XMLShake(XMLElement):
    """
    The shake element has a similar appearance to an inverted-mordent element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/shake/>`_
...
class XMLSmear(XMLElement):
    """
    The smear element represents the tilde-shaped smear symbol used in brass notation.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/smear/>`_
...
class XMLSchleifer(XMLElement):
    """
    The name for this ornament is based on the German, to avoid confusion with the more common slide element defined earlier.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/schleifer/>`_
...
class XMLInstruments(XMLElement):
    """
    The instruments element is only used if more than one instrument is represented in the part (e.g., oboe I and II where they play together most of the time). If absent, a value of 1 is assumed.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/instruments/>`_
...
class XMLMovementTitle(XMLElement):
    """
    The movement-title element specifies the title of a movement, not including its number.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/movement-title/>`_
...
class XMLPlop(XMLElement):
    """
    The plop element is an indeterminate slide attached to a single note. The plop appears before the main note and comes from above the main pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/plop/>`_
...
class XMLTrillMark(XMLElement):
    """
    The trill-mark element represents the trill-mark symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/trill-mark/>`_
...
class XMLKeyAccidental(XMLElement):
    """
    Non-traditional key signatures are represented using a list of altered tones. The key-accidental element indicates the accidental to be displayed in the key signature, represented in the same manner as the accidental element. It is used for disambiguating microtonal accidentals.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/key-accidental/>`_
...
class XMLAccordionMiddle(XMLElement):
    """
    The accordion-middle element indicates the presence of 1 to 3 dots in the middle (8') section of the registration symbol. This element is omitted if no dots are present.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/accordion-middle/>`_
...
class XMLChord(XMLElement):
    ...
    In most cases the duration will be the same as the preceding note. However it can be shorter in situations such as multiple stops for string instruments.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/chord/>`_
...
class XMLSoftAccent(XMLElement):
    """
    The soft-accent element indicates a soft accent that is not as heavy as a normal accent. It is often notated as <>. It can be combined with other articulations to implement the first eight symbols in the SMuFL Articulation supplement range.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/soft-accent/>`_
...
class XMLNormalNotes(XMLElement):
    """
    The normal-notes element describes how many notes are usually played in the time occupied by the number in the actual-notes element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/normal-notes/>`_
...
class XMLTurn(XMLElement):
    """
    The turn element is the normal turn shape which goes up then down.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/turn/>`_
...
class XMLAccent(XMLElement):
    """
    The accent element indicates a regular horizontal accent mark.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/accent/>`_
...
class XMLOtherArticulation(XMLElement):
    """
    The other-articulation element is used to define any articulations not yet in the MusicXML format. The smufl attribute can be used to specify a particular articulation, allowing application interoperability without requiring every SMuFL articulation to have a MusicXML element equivalent. Using the other-articulation element without the smufl attribute allows for extended representation, though without application interoperability.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/other-articulation/>`_
...
class XMLSpiccato(XMLElement):
    """
    The spiccato element is used for a stroke articulation, as opposed to a dot or a wedge.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/spiccato/>`_
...
class XMLInstrumentName(XMLElement):
    """
    The instrument-name element is typically used within a software application, rather than appearing on the printed page of a score.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/instrument-name/>`_
...
class XMLGroup(XMLElement):
    """
    The group element allows the use of different versions of the part for different purposes. Typical values include score, parts, sound, and data. Ordering information can be derived from the ordering within a MusicXML score or opus.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/group/>`_
...
class XMLTranspose(XMLElement):
    """
    If the part is being encoded for a transposing instrument in written vs. concert pitch, the transposition must be encoded in the transpose element using the transpose type.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/transpose/>`_
...
class XMLDownBow(XMLElement):
    """
    The down-bow element represents the symbol that is used both for down-bowing on bowed instruments, and down-stroke on plucked instruments.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/down-bow/>`_
...
class XMLNormalDot(XMLElement):
    """
    The normal-dot element is used to specify dotted normal tuplet types.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/normal-dot/>`_
...
class XMLTouchingPitch(XMLElement):
    """
    The touching-pitch is the pitch at which the string is touched lightly to produce the harmonic.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/touching-pitch/>`_
...
class XMLVerticalTurn(XMLElement):
    """
    The vertical-turn element has the turn symbol shape arranged vertically going from upper left to lower right.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/vertical-turn/>`_
...
class XMLPedalStep(XMLElement):
    """
    The pedal-step element defines the pitch step for a single harp pedal.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/pedal-step/>`_
...
class XMLKeyOctave(XMLElement):
    """
    The optional list of key-octave elements is used to specify in which octave each element of the key signature appears.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/key-octave/>`_
...
class XMLKeyAlter(XMLElement):
    """
    Non-traditional key signatures are represented using a list of altered tones. The key-alter element represents the alteration for a given pitch step, represented with semitones in the same manner as the alter element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/key-alter/>`_
...
class XMLTuningAlter(XMLElement):
    """
    The tuning-alter element is represented like the alter element, with a different name to reflect its different function in string tuning.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tuning-alter/>`_
...
class XMLGroupAbbreviationDisplay(XMLElement):
    """
    Formatting specified in the group-abbreviation-display element overrides formatting specified in the group-abbreviation element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/group-abbreviation-display/>`_
...
class XMLSenzaMisura(XMLElement):
    """
    A senza-misura element explicitly indicates that no time signature is present. The optional element content indicates the symbol to be used, if any, such as an X. The time element's symbol attribute is not used when a senza-misura element is present.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/senza-misura/>`_
...
class XMLThumbPosition(XMLElement):
    """
    The thumb-position element represents the thumb position symbol. This is a circle with a line, where the line does not come within the circle. It is distinct from the snap pizzicato symbol, where the line comes inside the circle.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/thumb-position/>`_
...
class XMLFlip(XMLElement):
    """
    The flip element represents the flip symbol used in brass notation.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/flip/>`_
...
class XMLEndLine(XMLElement):
    """
    The end-line element comes from RP-017 for Standard MIDI File Lyric meta-events. It facilitates lyric display for Karaoke and similar applications.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/end-line/>`_
...
class XMLBrassBend(XMLElement):
    """
    The brass-bend element represents the u-shaped bend symbol used in brass notation, distinct from the bend element used in guitar music.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/brass-bend/>`_
...
class XMLDelayedInvertedTurn(XMLElement):
    """
    The delayed-inverted-turn element indicates an inverted turn that is delayed until the end of the current note.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/delayed-inverted-turn/>`_
...
class XMLStress(XMLElement):
    """
    The stress element indicates a stressed note.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/stress/>`_
...
class XMLWords(XMLElement):
    """
    The words element specifies a standard text direction. The enclosure is none if not specified. The language is Italian ("it") if not specified. Left justification is used if not specified.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/words/>`_
...
class XMLStaffLines(XMLElement):
    """
    The staff-lines element specifies the number of lines and is usually used for a non 5-line staff. If the staff-lines element is present, the appearance of each line may be individually specified with a line-detail element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staff-lines/>`_
...
class XMLNatural(XMLElement):
    """
    The natural element indicates that this is a natural harmonic. These are usually notated at base pitch rather than sounding pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/natural/>`_
...
class XMLHoleType(XMLElement):
    """
    The content of the optional hole-type element indicates what the hole symbol represents in terms of instrument fingering or other techniques.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/hole-type/>`_
...
class XMLTuningOctave(XMLElement):
    """
    The tuning-octave element is represented like the octave element, with a different name to reflect its different function in string tuning.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/tuning-octave/>`_
...
class XMLVirtualName(XMLElement):
    """
    The virtual-name element indicates the library-specific name for the virtual instrument.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/virtual-name/>`_
...
class XMLSource(XMLElement):
    """
    The source for the music that is encoded. This is similar to the Dublin Core source element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/source/>`_
...
class XMLPlayerName(XMLElement):
    """
    The player-name element is typically used within a software application, rather than appearing on the printed page of a score.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/player-name/>`_
...
class XMLWithBar(XMLElement):
    """
    The with-bar element indicates that the bend is to be done at the bridge with a whammy or vibrato bar. The content of the element indicates how this should be notated. Content values of "scoop" and "dip" refer to the SMuFL guitarVibratoBarScoop and guitarVibratoBarDip glyphs.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/with-bar/>`_
...
class XMLOpenString(XMLElement):
    """
    The open-string element represents the zero-shaped open string symbol.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/open-string/>`_
...
class XMLInstrumentAbbreviation(XMLElement):
    """
    The optional instrument-abbreviation element is typically used within a software application, rather than appearing on the printed page of a score.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/instrument-abbreviation/>`_
...
class XMLChromatic(XMLElement):
    """
    The chromatic element represents the number of semitones needed to get from written to sounding pitch. This value does not include octave-change values; the values for both elements need to be added to the written pitch to get the correct sounding pitch.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/chromatic/>`_
...
class XMLFingernails(XMLElement):
    """
    The fingernails element is used in notation for harp and other plucked string instruments.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/fingernails/>`_
...
class XMLIpa(XMLElement):
    """
    The ipa element represents International Phonetic Alphabet (IPA) sounds for vocal music. String content is limited to IPA 2015 symbols represented in Unicode 13.0.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/ipa/>`_
...
class XMLClef(XMLElement):
    """
    Clefs are represented by a combination of sign, line, and clef-octave-change elements.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/clef/>`_
...
class XMLPrefix(XMLElement):
    """
    Values for the prefix element include plus and the accidental values sharp, flat, natural, double-sharp, flat-flat, and sharp-sharp. The prefix element may contain additional values for symbols specific to particular figured bass styles.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/prefix/>`_
...
class XMLKeyStep(XMLElement):
    """
    Non-traditional key signatures are represented using a list of altered tones. The key-step element indicates the pitch step to be altered, represented using the same names as in the step element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/key-step/>`_
...
class XMLPartSymbol(XMLElement):
    """
    The part-symbol element indicates how a symbol for a multi-staff part is indicated in the score.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/part-symbol/>`_
...
class XMLOpen(XMLElement):
    """
    The open element represents the open symbol, which looks like a circle. The smufl attribute can be used to distinguish different SMuFL glyphs that have a similar appearance such as brassMuteOpen and guitarOpenPedal. If not present, the default glyph is brassMuteOpen.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/open/>`_
...
class XMLDuration(XMLElement):
    ...
    The duration element moves the musical position when used in backup elements, forward elements, and note elements that do not contain a chord child element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/duration/>`_
...
class XMLStaves(XMLElement):
    """
    The staves element is used if there is more than one staff represented in the given part (e.g., 2 staves for typical piano parts). If absent, a value of 1 is assumed. Staves are ordered from top to bottom in a part in numerical order, with staff 1 above staff 2.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/staves/>`_
...
class XMLGroupLink(XMLElement):
    """
    Multiple part-link elements can reference different types of linked documents, such as parts and condensed score. The optional group-link elements identify the groups used in the linked document. The content of a group-link element should match the content of a group element in the linked document.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/group-link/>`_
...
class XMLActualNotes(XMLElement):
    """
    The actual-notes element describes how many notes are played in the time usually occupied by the number in the normal-notes element.`external documentation <https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/actual-notes/>`_
...
__all__=['XMLScorePartwise', 'XMLPart', 'XMLMeasure', 'XMLDirective', 'XMLGroupTime', 'XMLHarpPedals', 'XMLAlter', 'XMLDirection', 'XMLSlash', 'XMLText', 'XMLRepeat', 'XMLGolpe', 'XMLArrowStyle', 'XMLPerMinute', 'XMLPartTranspose', 'XMLBassStep', 'XMLCaesura', 'XMLForPart', 'XMLMetronomeTuplet', 'XMLTimeRelation', 'XMLPppppp', 'XMLFffff', 'XMLFrameFrets', 'XMLScoop', 'XMLHoleClosed', 'XMLSwingStyle', 'XMLListening', 'XMLBreathMark', 'XMLPitched', 'XMLPppp', 'XMLScoreInstrument', 'XMLSwing', 'XMLRightMargin', 'XMLAccordionHigh', 'XMLAssess', 'XMLCredit', 'XMLType', 'XMLEndParagraph', 'XMLHammerOn', 'XMLFp', 'XMLCoda', 'XMLHarmonic', 'XMLFingering', 'XMLDamp', 'XMLTupletActual', 'XMLEncoder', 'XMLMp', 'XMLMetronomeRelation', 'XMLStep', 'XMLTopSystemDistance', 'XMLHoleShape', 'XMLTimeModification', 'XMLBasePitch', 'XMLFfff', 'XMLFigure', 'XMLPageWidth', 'XMLTenuto', 'XMLLaughing', 'XMLTime', 'XMLLeftDivider', 'XMLLyric', 'XMLMeasureNumbering', 'XMLCue', 'XMLSffz', 'XMLStringMute', 'XMLMetronomeDot', 'XMLBeatUnitDot', 'XMLMetronomeType', 'XMLEncodingDescription', 'XMLString', 'XMLDoit', 'XMLRehearsal', 'XMLFeature', 'XMLPrint', 'XMLPartGroup', 'XMLEncodingDate', 'XMLHarmonClosed', 'XMLInstrumentChange', 'XMLEnding', 'XMLOctave', 'XMLTupletNormal', 'XMLInstrumentLink', 'XMLMetronomeArrows', 'XMLMordent', 'XMLDashes', 'XMLSemiPitched', 'XMLOtherOrnament', 'XMLDegreeAlter', 'XMLOtherListening', 'XMLWorkTitle', 'XMLLeftMargin', 'XMLNormalType', 'XMLPartClef', 'XMLBeam', 'XMLDouble', 'XMLAccordionRegistration', 'XMLTuningStep', 'XMLSoftware', 'XMLOctaveChange', 'XMLExceptVoice', 'XMLBeatUnit', 'XMLKey', 'XMLStaccato', 'XMLDefaults', 'XMLMiscellaneous', 'XMLSync', 'XMLSfzp', 'XMLDoubleTongue', 'XMLPedalAlter', 'XMLFalloff', 'XMLRelation', 'XMLSupports', 'XMLPf', 'XMLPp', 'XMLLyricLanguage', 'XMLP', 'XMLStrongAccent', 'XMLBassAlter', 'XMLDistance', 'XMLStopped', 'XMLMeasureLayout', 'XMLWorkNumber', 'XMLSlashDot', 'XMLAccordionLow', 'XMLSlashType', 'XMLScordatura', 'XMLStaffType', 'XMLFunction', 'XMLMetronomeTied', 'XMLMidiInstrument', 'XMLTenths', 'XMLFfffff', 'XMLRights', 'XMLDot', 'XMLInvertedVerticalTurn', 'XMLTripleTongue', 'XMLMetal', 'XMLDirectionType', 'XMLElevation', 'XMLBackup', 'XMLStaffSize', 'XMLMeasureDistance', 'XMLStaffDistance', 'XMLStickType', 'XMLStick', 'XMLCreditType', 'XMLSyllabic', 'XMLSlur', 'XMLStaffDetails', 'XMLInversion', 'XMLMillimeters', 'XMLRfz', 'XMLBeater', 'XMLGlissando', 'XMLTimpani', 'XMLSfp', 'XMLDivisions', 'XMLSnapPizzicato', 'XMLArrow', 'XMLSoundingPitch', 'XMLArrowDirection', 'XMLStickLocation', 'XMLPartLink', 'XMLSystemDistance', 'XMLVolume', 'XMLTechnical', 'XMLPreBend', 'XMLHumming', 'XMLBeatType', 'XMLMembrane', 'XMLInvertedTurn', 'XMLWedge', 'XMLMf', 'XMLPitch', 'XMLFrameStrings', 'XMLUnpitched', 'XMLTremolo', 'XMLInstrumentSound', 'XMLAccidentalText', 'XMLFifths', 'XMLTopMargin', 'XMLForward', 'XMLEffect', 'XMLArrowhead', 'XMLScaling', 'XMLMidiUnpitched', 'XMLTupletDot', 'XMLDampAll', 'XMLMiscellaneousField', 'XMLStaffDivide', 'XMLPageMargins', 'XMLPpppp', 'XMLGrouping', 'XMLGroupNameDisplay', 'XMLNumeralFifths', 'XMLMidiDevice', 'XMLBend', 'XMLSign', 'XMLWordFont', 'XMLUpBow', 'XMLMidiProgram', 'XMLMidiBank', 'XMLPartNameDisplay', 'XMLCreditWords', 'XMLBarline', 'XMLOffset', 'XMLEyeglasses', 'XMLOrnaments', 'XMLPan', 'XMLNumeralRoot', 'XMLKind', 'XMLDisplayStep', 'XMLEnsemble', 'XMLGroupAbbreviation', 'XMLOtherPercussion', 'XMLPartAbbreviationDisplay', 'XMLHaydn', 'XMLDiatonic', 'XMLRightDivider', 'XMLPluck', 'XMLMovementNumber', 'XMLLineWidth', 'XMLSolo', 'XMLBassSeparator', 'XMLMode', 'XMLOtherTechnical', 'XMLDynamics', 'XMLGlass', 'XMLPlayer', 'XMLStaff', 'XMLTap', 'XMLScorePart', 'XMLSlide', 'XMLOtherDirection', 'XMLTupletNumber', 'XMLBottomMargin', 'XMLBass', 'XMLStaffLayout', 'XMLMetronomeNote', 'XMLAccidental', 'XMLSound', 'XMLOctaveShift', 'XMLDisplayText', 'XMLLineDetail', 'XMLDetachedLegato', 'XMLNumeralAlter', 'XMLFootnote', 'XMLN', 'XMLImage', 'XMLStaffTuning', 'XMLListen', 'XMLNotehead', 'XMLAttributes', 'XMLBracket', 'XMLSecond', 'XMLConcertScore', 'XMLVirtualLibrary', 'XMLNonArpeggiate', 'XMLF', 'XMLArpeggiate', 'XMLTupletType', 'XMLBeats', 'XMLFrameNote', 'XMLLyricFont', 'XMLOtherDynamics', 'XMLDelayedTurn', 'XMLBarStyle', 'XMLFigureNumber', 'XMLClefOctaveChange', 'XMLFermata', 'XMLRootAlter', 'XMLMidiName', 'XMLInvertedMordent', 'XMLStaccatissimo', 'XMLSf', 'XMLBendAlter', 'XMLArtificial', 'XMLCapo', 'XMLCreator', 'XMLUnstress', 'XMLLine', 'XMLGrace', 'XMLRoot', 'XMLSystemLayout', 'XMLEncoding', 'XMLMeasureRepeat', 'XMLIdentification', 'XMLMidiChannel', 'XMLShake', 'XMLInterchangeable', 'XMLSmear', 'XMLSchleifer', 'XMLMute', 'XMLOtherNotation', 'XMLHole', 'XMLInstruments', 'XMLHalfMuted', 'XMLMovementTitle', 'XMLHeel', 'XMLMusicFont', 'XMLPpp', 'XMLPlop', 'XMLStickMaterial', 'XMLFrame', 'XMLTrillMark', 'XMLPullOff', 'XMLKeyAccidental', 'XMLAccordionMiddle', 'XMLChord', 'XMLPlay', 'XMLSegno', 'XMLTie', 'XMLSoftAccent', 'XMLNormalNotes', 'XMLTurn', 'XMLArticulations', 'XMLOpus', 'XMLFff', 'XMLFirstFret', 'XMLAccent', 'XMLNoteSize', 'XMLPercussion', 'XMLOtherArticulation', 'XMLSwingType', 'XMLMetronomeBeam', 'XMLSpiccato', 'XMLInstrumentName', 'XMLGroup', 'XMLLevel', 'XMLStraight', 'XMLOtherAppearance', 'XMLCreditImage', 'XMLTuplet', 'XMLTranspose', 'XMLFret', 'XMLNotations', 'XMLDownBow', 'XMLNormalDot', 'XMLTouchingPitch', 'XMLWait', 'XMLVerticalTurn', 'XMLDegreeValue', 'XMLToe', 'XMLSfz', 'XMLPedalStep', 'XMLFirst', 'XMLKeyOctave', 'XMLKeyAlter', 'XMLTuningAlter', 'XMLSuffix', 'XMLHandbell', 'XMLGroupAbbreviationDisplay', 'XMLSenzaMisura', 'XMLThumbPosition', 'XMLDegree', 'XMLFlip', 'XMLNote', 'XMLGroupBarline', 'XMLEndLine', 'XMLVirtualInstrument', 'XMLBrassBend', 'XMLStem', 'XMLRootStep', 'XMLTied', 'XMLDelayedInvertedTurn', 'XMLStress', 'XMLLink', 'XMLMultipleRest', 'XMLRf', 'XMLWords', 'XMLStaffLines', 'XMLSystemMargins', 'XMLMetronome', 'XMLCreditSymbol', 'XMLCircularArrow', 'XMLNumeralKey', 'XMLFiguredBass', 'XMLDegreeType', 'XMLSystemDividers', 'XMLGroupSymbol', 'XMLPedal', 'XMLAccidentalMark', 'XMLFf', 'XMLBarre', 'XMLRest', 'XMLPageLayout', 'XMLNatural', 'XMLHoleType', 'XMLNoteheadText', 'XMLGlyph', 'XMLRelease', 'XMLTuningOctave', 'XMLPartName', 'XMLVirtualName', 'XMLSymbol', 'XMLWood', 'XMLNumeral', 'XMLSource', 'XMLPartList', 'XMLSfpp', 'XMLGroupName', 'XMLPedalTuning', 'XMLPlayerName', 'XMLElision', 'XMLAccord', 'XMLWithBar', 'XMLOpenString', 'XMLInstrumentAbbreviation', 'XMLChromatic', 'XMLFingernails', 'XMLBookmark', 'XMLIpa', 'XMLBeatUnitTied', 'XMLWork', 'XMLClef', 'XMLOtherPlay', 'XMLWavyLine', 'XMLAppearance', 'XMLPageHeight', 'XMLPrincipalVoice', 'XMLPrefix', 'XMLVoice', 'XMLHarmony', 'XMLInstrument', 'XMLKeyStep', 'XMLPartSymbol', 'XMLCancel', 'XMLBeatRepeat', 'XMLOpen', 'XMLExtend', 'XMLDuration', 'XMLDisplayOctave', 'XMLStaves', 'XMLPartAbbreviation', 'XMLMeasureStyle', 'XMLOtherListen', 'XMLGroupLink', 'XMLActualNotes', 'XMLFz', 'XMLHarmonMute', 'XMLNumeralMode']
