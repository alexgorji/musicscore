...
__all__=['XMLScorePartwise', 'XMLPart', 'XMLMeasure', 'XMLDirective', 'XMLCancel', 'XMLArtificial', 'XMLCoda', 'XMLMf', 'XMLSoftware', 'XMLPitched', 'XMLStaffDivide', 'XMLDoubleTongue', 'XMLOtherAppearance', 'XMLChromatic', 'XMLSenzaMisura', 'XMLRelation', 'XMLAccordionRegistration', 'XMLKeyAlter', 'XMLHoleShape', 'XMLStaff', 'XMLPullOff', 'XMLForPart', 'XMLFingernails', 'XMLPageMargins', 'XMLBookmark', 'XMLHaydn', 'XMLTranspose', 'XMLBeatType', 'XMLTime', 'XMLMidiBank', 'XMLTupletActual', 'XMLAccordionLow', 'XMLStaccatissimo', 'XMLHoleClosed', 'XMLCredit', 'XMLMovementNumber', 'XMLMp', 'XMLStraight', 'XMLPitch', 'XMLFrameStrings', 'XMLNumeralFifths', 'XMLTie', 'XMLNumeralAlter', 'XMLBackup', 'XMLFootnote', 'XMLStrongAccent', 'XMLAccent', 'XMLBassStep', 'XMLDetachedLegato', 'XMLHalfMuted', 'XMLGroupAbbreviationDisplay', 'XMLDuration', 'XMLPartGroup', 'XMLInversion', 'XMLInstrument', 'XMLTopMargin', 'XMLSoundingPitch', 'XMLIpa', 'XMLSupports', 'XMLActualNotes', 'XMLSoftAccent', 'XMLTupletNumber', 'XMLDivisions', 'XMLBarStyle', 'XMLInterchangeable', 'XMLPlop', 'XMLStickMaterial', 'XMLSmear', 'XMLNotehead', 'XMLVirtualInstrument', 'XMLOtherPercussion', 'XMLAppearance', 'XMLSnapPizzicato', 'XMLFfffff', 'XMLMovementTitle', 'XMLMetronomeTuplet', 'XMLOffset', 'XMLOctaveShift', 'XMLImage', 'XMLScoop', 'XMLStaffTuning', 'XMLN', 'XMLAccordionMiddle', 'XMLSystemDividers', 'XMLFrame', 'XMLRelease', 'XMLRootStep', 'XMLLine', 'XMLMordent', 'XMLOtherOrnament', 'XMLTuplet', 'XMLPluck', 'XMLMeasureNumbering', 'XMLStopped', 'XMLGrouping', 'XMLWork', 'XMLPedalStep', 'XMLRf', 'XMLDownBow', 'XMLFermata', 'XMLSwingStyle', 'XMLOpus', 'XMLMeasureLayout', 'XMLInstrumentSound', 'XMLMode', 'XMLNumeralRoot', 'XMLPerMinute', 'XMLHandbell', 'XMLKey', 'XMLPartAbbreviationDisplay', 'XMLTopSystemDistance', 'XMLNormalNotes', 'XMLHarmonClosed', 'XMLPartName', 'XMLDisplayText', 'XMLTimpani', 'XMLArrowStyle', 'XMLRepeat', 'XMLEncoder', 'XMLMetronomeDot', 'XMLScorePart', 'XMLKeyOctave', 'XMLPartNameDisplay', 'XMLScaling', 'XMLAssess', 'XMLLyricLanguage', 'XMLStep', 'XMLOctaveChange', 'XMLPartList', 'XMLWavyLine', 'XMLDegreeAlter', 'XMLCreator', 'XMLLeftDivider', 'XMLAlter', 'XMLBarline', 'XMLUnpitched', 'XMLDashes', 'XMLCue', 'XMLGroupNameDisplay', 'XMLStaves', 'XMLPageHeight', 'XMLMetronomeArrows', 'XMLFingering', 'XMLInstrumentAbbreviation', 'XMLInvertedVerticalTurn', 'XMLOtherNotation', 'XMLGrace', 'XMLInvertedMordent', 'XMLMusicFont', 'XMLSf', 'XMLPlayerName', 'XMLGroupLink', 'XMLSign', 'XMLSwingType', 'XMLBeatUnit', 'XMLGroupName', 'XMLSecond', 'XMLString', 'XMLStaffLayout', 'XMLSegno', 'XMLUnstress', 'XMLTuningAlter', 'XMLStickType', 'XMLKeyStep', 'XMLOtherDynamics', 'XMLAccord', 'XMLEnding', 'XMLRehearsal', 'XMLFret', 'XMLThumbPosition', 'XMLFffff', 'XMLStaffLines', 'XMLPppp', 'XMLSlash', 'XMLMetronome', 'XMLRootAlter', 'XMLListen', 'XMLEnsemble', 'XMLDirection', 'XMLGroupTime', 'XMLHumming', 'XMLTuningOctave', 'XMLGroupSymbol', 'XMLGlissando', 'XMLTimeModification', 'XMLStaffDetails', 'XMLPartSymbol', 'XMLHeel', 'XMLSwing', 'XMLDynamics', 'XMLFifths', 'XMLEncodingDescription', 'XMLHole', 'XMLFrameNote', 'XMLFigure', 'XMLRoot', 'XMLNatural', 'XMLWedge', 'XMLPpppp', 'XMLSound', 'XMLEndParagraph', 'XMLExtend', 'XMLHoleType', 'XMLSolo', 'XMLOpen', 'XMLCreditSymbol', 'XMLMidiUnpitched', 'XMLDegreeValue', 'XMLMetronomeNote', 'XMLOtherArticulation', 'XMLRightMargin', 'XMLStaffDistance', 'XMLWordFont', 'XMLMidiProgram', 'XMLSyllabic', 'XMLShake', 'XMLListening', 'XMLMetal', 'XMLCaesura', 'XMLMultipleRest', 'XMLFeature', 'XMLGroupAbbreviation', 'XMLHammerOn', 'XMLFz', 'XMLWait', 'XMLBracket', 'XMLDisplayStep', 'XMLDefaults', 'XMLVoice', 'XMLClefOctaveChange', 'XMLMembrane', 'XMLTimeRelation', 'XMLForward', 'XMLArrowDirection', 'XMLOtherPlay', 'XMLSfzp', 'XMLLineWidth', 'XMLBeatUnitTied', 'XMLTupletDot', 'XMLMetronomeType', 'XMLSlashDot', 'XMLBrassBend', 'XMLOctave', 'XMLWorkTitle', 'XMLPedalAlter', 'XMLIdentification', 'XMLLaughing', 'XMLPp', 'XMLRightDivider', 'XMLRights', 'XMLBassAlter', 'XMLMidiInstrument', 'XMLTripleTongue', 'XMLBeats', 'XMLGlyph', 'XMLHarmony', 'XMLStick', 'XMLSource', 'XMLSpiccato', 'XMLSuffix', 'XMLLevel', 'XMLInstrumentName', 'XMLNormalType', 'XMLOtherListen', 'XMLPrint', 'XMLDot', 'XMLSchleifer', 'XMLPppppp', 'XMLFalloff', 'XMLBasePitch', 'XMLBend', 'XMLHarmonMute', 'XMLCircularArrow', 'XMLDouble', 'XMLDegreeType', 'XMLTuningStep', 'XMLSfz', 'XMLMillimeters', 'XMLDoit', 'XMLPedal', 'XMLText', 'XMLLyricFont', 'XMLExceptVoice', 'XMLNonArpeggiate', 'XMLAccidentalMark', 'XMLMetronomeRelation', 'XMLSystemLayout', 'XMLPartClef', 'XMLLyric', 'XMLTremolo', 'XMLTied', 'XMLPlayer', 'XMLEyeglasses', 'XMLBendAlter', 'XMLPrincipalVoice', 'XMLWithBar', 'XMLToe', 'XMLSemiPitched', 'XMLSystemDistance', 'XMLBottomMargin', 'XMLPedalTuning', 'XMLNumeralMode', 'XMLHarmonic', 'XMLConcertScore', 'XMLUpBow', 'XMLEncodingDate', 'XMLCapo', 'XMLNoteSize', 'XMLStem', 'XMLType', 'XMLInstrumentLink', 'XMLAccordionHigh', 'XMLArticulations', 'XMLVerticalTurn', 'XMLDirectionType', 'XMLFp', 'XMLNote', 'XMLMeasureStyle', 'XMLFunction', 'XMLDisplayOctave', 'XMLStringMute', 'XMLLeftMargin', 'XMLMetronomeBeam', 'XMLTenuto', 'XMLMute', 'XMLLink', 'XMLDamp', 'XMLPan', 'XMLDelayedTurn', 'XMLNotations', 'XMLPageLayout', 'XMLStaffSize', 'XMLClef', 'XMLPrefix', 'XMLEffect', 'XMLFlip', 'XMLSync', 'XMLFfff', 'XMLSffz', 'XMLDampAll', 'XMLMetronomeTied', 'XMLNumeralKey', 'XMLBassSeparator', 'XMLWords', 'XMLInstruments', 'XMLCreditImage', 'XMLTrillMark', 'XMLEncoding', 'XMLInvertedTurn', 'XMLRfz', 'XMLSlur', 'XMLElision', 'XMLBreathMark', 'XMLOrnaments', 'XMLP', 'XMLSymbol', 'XMLInstrumentChange', 'XMLCreditType', 'XMLHarpPedals', 'XMLPlay', 'XMLGroupBarline', 'XMLMiscellaneousField', 'XMLFf', 'XMLLineDetail', 'XMLPreBend', 'XMLSfp', 'XMLDistance', 'XMLMeasureRepeat', 'XMLNumeral', 'XMLFff', 'XMLBeater', 'XMLScordatura', 'XMLOpenString', 'XMLPercussion', 'XMLTurn', 'XMLBass', 'XMLPartTranspose', 'XMLBarre', 'XMLTupletType', 'XMLGolpe', 'XMLSlashType', 'XMLTenths', 'XMLTechnical', 'XMLBeam', 'XMLVirtualLibrary', 'XMLElevation', 'XMLStickLocation', 'XMLChord', 'XMLSystemMargins', 'XMLOtherDirection', 'XMLTap', 'XMLRest', 'XMLMiscellaneous', 'XMLPageWidth', 'XMLFiguredBass', 'XMLScoreInstrument', 'XMLWood', 'XMLArrow', 'XMLOtherTechnical', 'XMLMidiName', 'XMLAccidentalText', 'XMLF', 'XMLDelayedInvertedTurn', 'XMLFirstFret', 'XMLPpp', 'XMLKeyAccidental', 'XMLFigureNumber', 'XMLNormalDot', 'XMLDiatonic', 'XMLDegree', 'XMLArrowhead', 'XMLSlide', 'XMLFrameFrets', 'XMLPf', 'XMLTouchingPitch', 'XMLWorkNumber', 'XMLVirtualName', 'XMLBeatUnitDot', 'XMLMeasureDistance', 'XMLBeatRepeat', 'XMLPartAbbreviation', 'XMLTupletNormal', 'XMLAccidental', 'XMLGlass', 'XMLCreditWords', 'XMLArpeggiate', 'XMLVolume', 'XMLOtherListening', 'XMLFirst', 'XMLGroup', 'XMLEndLine', 'XMLMidiDevice', 'XMLPartLink', 'XMLAttributes', 'XMLKind', 'XMLStress', 'XMLStaffType', 'XMLSfpp', 'XMLMidiChannel', 'XMLNoteheadText', 'XMLStaccato']
