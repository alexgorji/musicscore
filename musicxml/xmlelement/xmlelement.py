...
__all__=['XMLScorePartwise', 'XMLStaffDistance', 'XMLFret', 'XMLDistance', 'XMLPartList', 'XMLSolo', 'XMLAccidentalText', 'XMLWorkNumber', 'XMLGlyph', 'XMLSlashType', 'XMLMetronome', 'XMLAccidentalMark', 'XMLEyeglasses', 'XMLMidiInstrument', 'XMLScordatura', 'XMLDoit', 'XMLHoleType', 'XMLOtherListen', 'XMLFunction', 'XMLArticulations', 'XMLPppppp', 'XMLCoda', 'XMLPercussion', 'XMLVirtualInstrument', 'XMLVolume', 'XMLOtherArticulation', 'XMLVirtualLibrary', 'XMLPageMargins', 'XMLEndParagraph', 'XMLElevation', 'XMLDouble', 'XMLKind', 'XMLSwingStyle', 'XMLSemiPitched', 'XMLGroupLink', 'XMLSenzaMisura', 'XMLMidiName', 'XMLMiscellaneousField', 'XMLSync', 'XMLP', 'XMLSystemDividers', 'XMLHarmonClosed', 'XMLTuplet', 'XMLCue', 'XMLSmear', 'XMLCircularArrow', 'XMLTap', 'XMLFirst', 'XMLFlip', 'XMLSound', 'XMLWait', 'XMLDashes', 'XMLHarmonic', 'XMLDegree', 'XMLStaffTuning', 'XMLSfpp', 'XMLGroupBarline', 'XMLTranspose', 'XMLPluck', 'XMLPart', 'XMLDampAll', 'XMLSource', 'XMLText', 'XMLTremolo', 'XMLCreator', 'XMLMusicFont', 'XMLDoubleTongue', 'XMLWorkTitle', 'XMLNormalType', 'XMLBasePitch', 'XMLCreditType', 'XMLStick', 'XMLKeyAccidental', 'XMLNormalDot', 'XMLHalfMuted', 'XMLEncoder', 'XMLMidiBank', 'XMLSymbol', 'XMLNumeralFifths', 'XMLArrowhead', 'XMLOtherDynamics', 'XMLTied', 'XMLRights', 'XMLHoleShape', 'XMLKey', 'XMLNonArpeggiate', 'XMLFrameStrings', 'XMLGroup', 'XMLDegreeType', 'XMLMillimeters', 'XMLOpus', 'XMLMetronomeNote', 'XMLPartAbbreviationDisplay', 'XMLPan', 'XMLDirection', 'XMLChromatic', 'XMLMetal', 'XMLCaesura', 'XMLBeatType', 'XMLAssess', 'XMLNormalNotes', 'XMLNoteSize', 'XMLLevel', 'XMLNote', 'XMLTimeModification', 'XMLGlass', 'XMLAccordionLow', 'XMLBass', 'XMLStress', 'XMLExtend', 'XMLInstrumentName', 'XMLAccordionMiddle', 'XMLKeyStep', 'XMLInstrumentChange', 'XMLPageLayout', 'XMLNotehead', 'XMLFalloff', 'XMLMp', 'XMLRfz', 'XMLElision', 'XMLFrame', 'XMLMidiChannel', 'XMLPppp', 'XMLPitched', 'XMLStem', 'XMLPrincipalVoice', 'XMLFrameFrets', 'XMLWood', 'XMLEncodingDescription', 'XMLPp', 'XMLTupletDot', 'XMLBrassBend', 'XMLMidiUnpitched', 'XMLAccent', 'XMLPartTranspose', 'XMLTuningAlter', 'XMLFigure', 'XMLSfz', 'XMLInversion', 'XMLMiscellaneous', 'XMLGolpe', 'XMLSyllabic', 'XMLBreathMark', 'XMLTie', 'XMLRepeat', 'XMLSoftware', 'XMLMeasureRepeat', 'XMLTenuto', 'XMLPullOff', 'XMLOpen', 'XMLPrint', 'XMLBarre', 'XMLPlayerName', 'XMLHarmonMute', 'XMLNoteheadText', 'XMLSlide', 'XMLOrnaments', 'XMLFifths', 'XMLKeyOctave', 'XMLTouchingPitch', 'XMLWedge', 'XMLMetronomeDot', 'XMLPartNameDisplay', 'XMLStickType', 'XMLF', 'XMLBottomMargin', 'XMLRf', 'XMLStaves', 'XMLStaffSize', 'XMLSystemMargins', 'XMLSystemLayout', 'XMLN', 'XMLVerticalTurn', 'XMLSlashDot', 'XMLOctave', 'XMLLineWidth', 'XMLSecond', 'XMLPlop', 'XMLScaling', 'XMLSlur', 'XMLOtherAppearance', 'XMLPageHeight', 'XMLInterchangeable', 'XMLMeasureStyle', 'XMLLeftDivider', 'XMLListening', 'XMLTopMargin', 'XMLStaffDetails', 'XMLTupletNumber', 'XMLArrow', 'XMLScorePart', 'XMLSfzp', 'XMLOtherDirection', 'XMLVoice', 'XMLRest', 'XMLStringMute', 'XMLUnstress', 'XMLEffect', 'XMLMovementTitle', 'XMLTime', 'XMLDelayedInvertedTurn', 'XMLBeatRepeat', 'XMLChord', 'XMLLineDetail', 'XMLDirectionType', 'XMLWork', 'XMLOtherPercussion', 'XMLSlash', 'XMLLine', 'XMLFff', 'XMLLaughing', 'XMLInstruments', 'XMLFiguredBass', 'XMLIpa', 'XMLStep', 'XMLRootStep', 'XMLForward', 'XMLMultipleRest', 'XMLArpeggiate', 'XMLCancel', 'XMLStaffLayout', 'XMLFingernails', 'XMLPartAbbreviation', 'XMLOffset', 'XMLAccord', 'XMLTuningStep', 'XMLDiatonic', 'XMLPpp', 'XMLPedal', 'XMLEnsemble', 'XMLPartClef', 'XMLKeyAlter', 'XMLSfp', 'XMLStickMaterial', 'XMLGrace', 'XMLStrongAccent', 'XMLPedalAlter', 'XMLGroupTime', 'XMLLeftMargin', 'XMLDivisions', 'XMLRightMargin', 'XMLBeats', 'XMLInvertedVerticalTurn', 'XMLNumeralRoot', 'XMLTimeRelation', 'XMLOtherTechnical', 'XMLGroupSymbol', 'XMLSuffix', 'XMLSnapPizzicato', 'XMLPedalTuning', 'XMLNumeralMode', 'XMLLyric', 'XMLPrefix', 'XMLSegno', 'XMLRelation', 'XMLStickLocation', 'XMLBend', 'XMLHumming', 'XMLStaff', 'XMLGroupAbbreviationDisplay', 'XMLWavyLine', 'XMLAccidental', 'XMLTuningOctave', 'XMLBeater', 'XMLDamp', 'XMLMetronomeArrows', 'XMLThumbPosition', 'XMLDisplayText', 'XMLFrameNote', 'XMLDefaults', 'XMLTurn', 'XMLInvertedTurn', 'XMLFz', 'XMLBeatUnitTied', 'XMLExceptVoice', 'XMLMovementNumber', 'XMLCreditWords', 'XMLBarStyle', 'XMLSupports', 'XMLActualNotes', 'XMLHammerOn', 'XMLNotations', 'XMLFigureNumber', 'XMLSystemDistance', 'XMLListen', 'XMLAccordionHigh', 'XMLShake', 'XMLOtherListening', 'XMLSchleifer', 'XMLBeatUnitDot', 'XMLDetachedLegato', 'XMLToe', 'XMLDot', 'XMLLyricFont', 'XMLWithBar', 'XMLBassStep', 'XMLGroupAbbreviation', 'XMLRoot', 'XMLConcertScore', 'XMLArrowStyle', 'XMLStopped', 'XMLOctaveShift', 'XMLPpppp', 'XMLVirtualName', 'XMLMetronomeType', 'XMLTupletActual', 'XMLBookmark', 'XMLSoundingPitch', 'XMLRehearsal', 'XMLTupletNormal', 'XMLGrouping', 'XMLRootAlter', 'XMLString', 'XMLNumeralAlter', 'XMLDirective', 'XMLInstrumentLink', 'XMLSign', 'XMLSf', 'XMLStaffDivide', 'XMLFirstFret', 'XMLPageWidth', 'XMLPreBend', 'XMLOpenString', 'XMLEnding', 'XMLPartSymbol', 'XMLPedalStep', 'XMLPartGroup', 'XMLDuration', 'XMLMute', 'XMLBeam', 'XMLHoleClosed', 'XMLMordent', 'XMLMeasureNumbering', 'XMLRelease', 'XMLNumeral', 'XMLRightDivider', 'XMLForPart', 'XMLPartName', 'XMLSwingType', 'XMLScoreInstrument', 'XMLCreditImage', 'XMLTrillMark', 'XMLCreditSymbol', 'XMLSoftAccent', 'XMLOtherNotation', 'XMLAlter', 'XMLMeasureDistance', 'XMLSpiccato', 'XMLDelayedTurn', 'XMLMf', 'XMLEncoding', 'XMLPartLink', 'XMLPerMinute', 'XMLTenths', 'XMLMidiDevice', 'XMLClefOctaveChange', 'XMLDisplayOctave', 'XMLFingering', 'XMLCapo', 'XMLMeasure', 'XMLFffff', 'XMLUpBow', 'XMLClef', 'XMLGroupName', 'XMLNumeralKey', 'XMLBackup', 'XMLNatural', 'XMLMetronomeTuplet', 'XMLHarmony', 'XMLSwing', 'XMLTopSystemDistance', 'XMLStaccatissimo', 'XMLTimpani', 'XMLBracket', 'XMLMeasureLayout', 'XMLFeature', 'XMLFermata', 'XMLFfffff', 'XMLScoop', 'XMLInstrumentAbbreviation', 'XMLPlay', 'XMLMetronomeRelation', 'XMLArrowDirection', 'XMLLyricLanguage', 'XMLFp', 'XMLBendAlter', 'XMLInvertedMordent', 'XMLFfff', 'XMLTechnical', 'XMLWords', 'XMLEncodingDate', 'XMLHaydn', 'XMLInstrument', 'XMLLink', 'XMLMembrane', 'XMLDegreeValue', 'XMLDegreeAlter', 'XMLFootnote', 'XMLSffz', 'XMLDisplayStep', 'XMLMode', 'XMLBeatUnit', 'XMLHandbell', 'XMLEndLine', 'XMLCredit', 'XMLTripleTongue', 'XMLTupletType', 'XMLInstrumentSound', 'XMLBarline', 'XMLBassSeparator', 'XMLOctaveChange', 'XMLIdentification', 'XMLUnpitched', 'XMLImage', 'XMLArtificial', 'XMLPitch', 'XMLStaccato', 'XMLOtherPlay', 'XMLGlissando', 'XMLDownBow', 'XMLStaffType', 'XMLMidiProgram', 'XMLMetronomeTied', 'XMLStaffLines', 'XMLStraight', 'XMLFf', 'XMLHarpPedals', 'XMLPf', 'XMLPlayer', 'XMLHeel', 'XMLType', 'XMLAttributes', 'XMLDynamics', 'XMLMetronomeBeam', 'XMLAppearance', 'XMLGroupNameDisplay', 'XMLAccordionRegistration', 'XMLBassAlter', 'XMLWordFont', 'XMLOtherOrnament', 'XMLHole']
