...
class XSDComplexTypeLevel(XSDComplexType, XSDSimpleTypeString):
...
class XSDComplexTypeMeasureRepeat(XSDComplexType, XSDSimpleTypePositiveIntegerOrEmpty):
...
class XSDComplexTypeStaffSize(XSDComplexType, XSDSimpleTypeNonNegativeDecimal):
...
class XSDComplexTypeEnding(XSDComplexType, XSDSimpleTypeString):
...
class XSDComplexTypeKind(XSDComplexType, XSDSimpleTypeKindValue):
...
class XSDComplexTypeMeasureNumbering(XSDComplexType, XSDSimpleTypeMeasureNumberingValue):
...
class XSDComplexTypeOffset(XSDComplexType, XSDSimpleTypeDivisions):
...
class XSDComplexTypeBeam(XSDComplexType, XSDSimpleTypeBeamValue):
...
class XSDComplexTypeNotehead(XSDComplexType, XSDSimpleTypeNoteheadValue):
...
class XSDComplexTypeTremolo(XSDComplexType, XSDSimpleTypeTremoloMarks):
